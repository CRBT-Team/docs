...
I've also started to clean up CRBT from the inside out to only keep the features that matter and to focus on newer stuff like [Role Pickers, Localizations & Moderation](/11.5-changelog).

If you have any questions, please feel free to join our [Community server](https://crbt.app/discord) and ask away!
