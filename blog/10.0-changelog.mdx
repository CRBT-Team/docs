...
- Renamed "Data collection" to "Telemetry", changed "On/Off" to "Minimal/Complete" and made the "Complete" mode less intrusive than the previous "On" setting. Check the [Privacy policy](https://crbt.app/policy) for more info.
