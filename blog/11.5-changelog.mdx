...
<img
  src='https://i.imgur.com/fr14Zbi.gif'
  alt='Selecting a role from multiple color role choices.'
/>
<p class='subtext'>Simply select a role from a given list to get the role.</p>

For a more in-depth guide on Role Pickers, check out [this article](/introduction-to-role-pickers).
...
Fluent in another language? Your contribution is welcome!<br />
You can help by translating CRBT into your language. Join our [Community server](https://crbt.app/discord) and our [Crowdin project](https://crowdin.com/project/crbt) for more info.
...
<img
  src='https://i.imgur.com/KWnjDLK.gif'
  alt='Transition to the new front page'
/>
<p class='subtext'>The new dark theme with red accents and round buttons.</p>

<img src='https://i.imgur.com/1kxkc69.gif' alt='The new illustrations' />
...
<img src='https://i.imgur.com/MDiWgbA.png' alt='The new desktop navbar' />
...
<img
  src='https://i.imgur.com/i04VFDx.png'
  alt='The new mobile navbar, with tabs'
/>
<p class='subtext'>
  The new navigation bar for mobile. Tell me what you think on the
  <a href='/invite'>Discord server</a>.
</p>
...
You can read more about my decision to remove profiles & economy [here](https://crbt.app/blog/rethinking-crbt-profiles-economy).
